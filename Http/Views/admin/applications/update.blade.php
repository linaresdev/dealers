				...
				<form action="{{__url('__now')}}"
					...
					<div class="form-floating mb-3">
						<select name="method" 
								...
								aria-label="method"
								class="form-select">
							<option value="GET" @if(old("method", $api->method) == "GET") selected @endif>
								GET
							</option>
							<option value="POST" @if(old("method", $api->method) == "POST") selected @endif>
								POST
							</option>
							<option value="ANY" @if(old("method", $api->method) == "ANY") selected @endif>
					...
					<div class="form-floating mb-3">
						<input type="text"
								name="controller"
								value="{{old("controller", $api->controller)}}"
								id="controller" 
								class="form-control"
					...
					<div class="form-floating mb-3">
						<textarea 
							...
							style="min-height: 150px;">{{old("comment", $api->comment)}}</textarea>
