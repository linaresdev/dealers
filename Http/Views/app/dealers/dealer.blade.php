						...
						<td class="action">
							...
							<div class="dropdown dropstart">
								...
								<div class="dropdown-menu headering">
									...
									<a href="{{__url('dealers/update/'.$dealer->id)}}" 
										class="dropdown-item">
										{{__("account.update")}}
									</a>
									<a href="{{__url('dealers/update/'.$dealer->id.'/logo')}}" class="dropdown-item">
										{{__("update.logo")}}
									</a>
									...
									<a href="{{__url('dealers/'.$dealer->id.'/users')}}" class="dropdown-item">
										{{__("words.users")}}
									</a>
								</div>
							</div>
